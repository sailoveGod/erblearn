...
cursor.execute("INSERT INTO orders (order_id, customer_id, product_id, unit_price, order_qty, amount, order_date) VALUES(?,?,?,?,?,?,?)",('1','1','1','6000','1','6000','2024-1-1'))
cursor.execute("INSERT INTO orders (order_id, customer_id, product_id, unit_price, order_qty, amount, order_date) VALUES(?,?,?,?,?,?,?)",('2','2','1','6000','1','6000','2024-5-1'))
